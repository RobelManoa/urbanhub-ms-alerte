...
class RabbitMQConsumer:
    def __init__(self, use_case: ValidateTrafficUseCase) -> None:
    ...
    def callback(self, ch, method, properties, body) -> None:
        ...
        payload = TrafficWindow(
            ...
            window_start=datetime.fromisoformat(data.get("windowStart", "").replace("Z", "+00:00")),
            window_end=datetime.fromisoformat(data.get("windowEnd", "").replace("Z", "+00:00")),
            vehicles=[
                VehicleReading(speed_kmh=item.get("speedKmh", 0), vehicle_type=item.get("vehicleType", ""))
    ...
    def start_consuming(self) -> None:
        ...
        print("Waiting for validated traffic messages...")
